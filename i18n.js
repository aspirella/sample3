...
class i18NManager {
    constructor() {
        this.registry = [
            ...
            { region: "Australia", language: "English", language_code: "en", country_code: "AU", locale: "en-AU", flag: "🇦🇺" },
            ...
            { region: "Canada", language: "English", language_code: "en", country_code: "CA", locale: "en-CA", flag: "🇨🇦" },
            { region: "Canada", language: "Français", language_code: "fr", country_code: "CA", locale: "fr-CA", flag: "🇨🇦" },
            { region: "China", language: "中文", language_code: "zh", country_code: "CN", locale: "zh-CN", flag: "🇨🇳" },
            ...
            { region: "Singapore", language: "English", language_code: "en", country_code: "SG", locale: "en-SG", flag: "🇸🇬" },
            ...
            { region: "United Kingdom", language: "English", language_code: "en", country_code: "GB", locale: "en-GB", flag: "🇬🇧" },
            { region: "USA", language: "English", language_code: "en", country_code: "US", locale: "en-US", flag: "🇺🇸" },
    ...
    getDisplayName(item) {
        if (item.isGlobal) return item.region.toUpperCase() + ' (' + item.language.toLowerCase() + ')';
        return item.region + ' (' + item.language + ')';
    }
...
i18n.init(); // Initialize immediately to be ready for app.js
